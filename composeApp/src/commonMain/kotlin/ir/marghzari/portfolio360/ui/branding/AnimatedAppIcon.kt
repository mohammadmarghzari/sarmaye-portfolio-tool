...
private val PORTFOLIO_VIOLET = Color(0xFF7C3AED)
private val PORTFOLIO_VIOLET_SOFT = Color(0xFFA78BFA)
private val PORTFOLIO_DARK = Color(0xFF1E0A4E)
    ...
    Canvas(modifier = modifier.size(size)) {
        ...
        drawCircle(
            brush = Brush.radialGradient(
                listOf(PORTFOLIO_VIOLET.copy(alpha = 0.35f * glow), Color.Transparent),
        ...
        rotate(degrees = rotation, pivot = Offset(cx, cy)) {
            drawCircle(
                brush = Brush.sweepGradient(
                    listOf(PORTFOLIO_VIOLET, PORTFOLIO_VIOLET_SOFT, PORTFOLIO_VIOLET),
                    center = Offset(cx, cy),
                ),
                radius = ringRadius,
                center = Offset(cx, cy),
        ...
        heights.forEachIndexed { i, h ->
            ...
            drawRect(
                brush = Brush.verticalGradient(
                    listOf(PORTFOLIO_VIOLET.copy(alpha = 0.95f), PORTFOLIO_VIOLET_SOFT),
